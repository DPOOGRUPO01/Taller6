...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	private final static String BORRAR_LIBROS = "eliminarLibro";
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(CAMBIAR_NOMBRE_CATEGORIA, "Cambiar nombre de una categoria", "./data/iconos/nombre3.png");
		agregarBoton(BORRAR_LIBROS, "Borrar un libro", "./data/iconos/borrar.png");
	}
